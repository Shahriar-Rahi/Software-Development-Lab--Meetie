...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(procrastinator.meetie.R.layout.activity_main);

        Toolbar toolbar = (Toolbar) findViewById(procrastinator.meetie.R.id.toolbar);
        if(toolbar != null) {
            setSupportActionBar(toolbar);
            getSupportActionBar().setTitle("Meetie");
        }

        viewPager = (ViewPager) findViewById(procrastinator.meetie.R.id.viewpager);
        floatButton = (FloatingActionButton) findViewById(procrastinator.meetie.R.id.fab);
        initTab();
        initFirebase();
    }
    ...
    private void initTab() {
        tabLayout = (TabLayout) findViewById(procrastinator.meetie.R.id.tabs);
        tabLayout.setSelectedTabIndicatorColor(getResources().getColor(procrastinator.meetie.R.color.colorIndivateTab));
    ...
    private void setupTabIcons() {
        int[] tabIcons = {
                procrastinator.meetie.R.drawable.ic_tab_person,
                procrastinator.meetie.R.drawable.ic_tab_group,
                procrastinator.meetie.R.drawable.ic_tab_infor
        };
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (adapter.getItem(position) instanceof FriendsFragment) {
                    ...
                    floatButton.setImageResource(procrastinator.meetie.R.drawable.plus);
                    ...
                    floatButton.setImageResource(procrastinator.meetie.R.drawable.ic_float_add_group);
                } else {
...
//    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(procrastinator.meetie.R.menu.menu_main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == procrastinator.meetie.R.id.about) {
            Toast.makeText(this, "Meetie version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
